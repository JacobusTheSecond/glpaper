...
static void draw(GLuint prog) {
	...
	//printf("setting time to %f\n",(utils_get_time_millis() - start) / 1000.0f);
...
//block of nop functions

void wl_registry_listener_global_remove(void* data, struct wl_registry* wl_registry, uint name){}

void zxdg_output_v1_listener_description(void* data, struct zxdg_output_v1* output, const char * name){}
void zxdg_output_v1_listener_done(void* data, struct zxdg_output_v1* output){}
void zxdg_output_v1_listener_logical_position(void* data, struct zxdg_output_v1* output, int32_t x, int32_t y){}
void zxdg_output_v1_listener_logical_size(void* data, struct zxdg_output_v1* output, int32_t x, int32_t y){}

void wl_output_listener_done(void* data, struct wl_output * output){}
void wl_output_listener_geometry(void* data, struct wl_output * output,int32_t a, int32_t b, int32_t c, int32_t d, int32_t e, const char* f, const char* g, int32_t h){}
void wl_output_listener_scale(void* data, struct wl_output * output, int32_t scale){}
void wl_output_listener_name(void* data, struct wl_output * output, const char * name){}
void wl_output_listener_description(void* data, struct wl_output * output, const char * name){}

void zwlr_layer_surface_v1_listener_closed(void* data, struct zwlr_layer_surface_v1* surface){}

void paper_init(char* _monitor, char* frag_path, uint16_t fps, char* layer_name, uint16_t width, uint16_t height, time_t _start) {
	monitor = _monitor;
	start = _start;//utils_get_time_millis();
	...
	wl_list_for_each(node, &outputs, link) {
		...
		struct zxdg_output_v1_listener xdg_listener = {
			.description = zxdg_output_v1_listener_description,
			.done = zxdg_output_v1_listener_done,
			.logical_position = zxdg_output_v1_listener_logical_position,
			.logical_size = zxdg_output_v1_listener_logical_size,
			.name = get_name
		};
		zxdg_output_v1_add_listener(xdg_output, &xdg_listener, node);

		struct wl_output_listener out_listener = {
			.done = wl_output_listener_done,
			.geometry = wl_output_listener_geometry,
			.mode = get_res,
			.scale = wl_output_listener_scale,
			.name = wl_output_listener_name,
			.description = wl_output_listener_description
		};
	...
	struct zwlr_layer_surface_v1_listener surface_listener = {
		.closed = zwlr_layer_surface_v1_listener_closed,
	...
	while(true) {
		...
		if(!eglSwapBuffers(egl_display, egl_surface)){
			printf("eglSwapBuffers returned false\n");
		}
	}
}
